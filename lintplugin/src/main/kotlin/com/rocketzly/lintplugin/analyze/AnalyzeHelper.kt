...
import com.rocketzly.lintplugin.task.LintOptionsDataAdapter.Companion.XML_OUTPUT_RELATIVE_PATH
...
class AnalyzeHelper : LintHelper {
    ...
    override fun apply(project: Project) {
        ...
        project.gradle.taskGraph.whenReady {
            it.allTasks.find {
                if (it.name.startsWith(LintTaskHelper.TASK_NAME_LINT_INCREMENT) ||
                    it.name.startsWith(LintTaskHelper.TASK_NAME_LINT_FULL)
                ) {
                    return@find true
                }
                return@find false
